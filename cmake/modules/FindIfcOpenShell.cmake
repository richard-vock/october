...
if(EXISTS ${IFCOPENSHELL_GEOM_LIBRARY_PATH} AND EXISTS ${IFCOPENSHELL_PARSE_LIBRARY_PATH})
    ...
    find_path(IFCOPENSHELL_GEOM_LIBRARY_DIR ${IFCOPENSHELL_GEOM_LIBRARY} HINTS "/usr/lib" "/usr/local/lib" "/usr/x86_64-w64-mingw32/lib")
    find_path(IFCOPENSHELL_PARSE_LIBRARY_DIR ${IFCOPENSHELL_PARSE_LIBRARY} HINTS "/usr/lib" "/usr/local/lib" "/usr/x86_64-w64-mingw32/lib")
endif()

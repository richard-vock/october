...
find_path(OPENCASCADE_INCLUDE_DIR "gp_Pnt.hxx" HINTS "/usr/include" "/usr/local/include" "$ENV{PROGRAMFILES}" "/usr/x86_64-w64-mingw32/include/oce" PATH_SUFFIXES "oce")
...
foreach(ITEM IN LISTS OPENCASCADE_LIB_SEARCH)
    ...
    find_library(ITEM_PATH ${ITEM} HINTS "/usr/lib" "/usr/local/lib" "$ENV{PROGRAMFILES}" "/usr/x86_64-w64-mingw32/Win64/lib")
    if(EXISTS ${ITEM_PATH})
        get_filename_component(ITEM_LIBRARY ${ITEM_PATH} NAME)
        find_path(ITEM_LIBRARY_DIR ${ITEM_LIBRARY} HINTS "/usr/lib" "/usr/local/lib" "/usr/x86_64-w64-mingw32/Win64/lib")
